...
import jmetal.metaheuristics.nsgaII.NSGAII_ProblemTSP;

/**
 * Settings class of algorithm NSGA-II (permutation encoding)
 */
public class NSGAIIPermutation_SettingsTSP extends Settings {
   ...
   * Constructor
   */
  public NSGAIIPermutation_SettingsTSP(String problem) {
    super(problem) ;
    
    Object [] problemParams = {"TSPPermutation", "distancias.txt"};
    try {
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new NSGAII_ProblemTSP((Problem)problem_);
    ...
    crossover = CrossoverFactory.getCrossoverOperator("PMXCrossoverTSP", parameters);
  ...
  public Algorithm configure(Properties configuration) throws JMException {
    ...
    algorithm = new NSGAII_ProblemTSP((Problem)problem_); //algorithm = new NSGAII(problem_) ;
