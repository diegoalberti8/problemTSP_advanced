//  SPEA2Permutation_Settings.java
//
//  Authors:
...
/**
 * Settings class of algorithm SPEA2 (permutation encoding)
 */
public class SPEA2Permutation_SettingsTSP extends Settings {
   ...
   * Constructor
   */
  public SPEA2Permutation_SettingsTSP(String problem) {
    super(problem) ;
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new SPEA2((Problem)problem_);
