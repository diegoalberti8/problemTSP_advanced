 ...
 */
public class SPEA2_SettingsTSP extends Settings {
   ...
   * Constructor
   */
  public SPEA2_SettingsTSP(String problem) {
    super(problem) ;
    
    Object [] problemParams = {"TSPPermutation"};
    try {
    ...
    mutationProbability_      = 0.2 ;   //mutationProbability_   = 1.0/problem_.getNumberOfVariables() ;
