 ...
 */
public class jMetalExperimentTSP extends Experiment {
  ...
  public void algorithmSettings(String problemName, 
    ...
    try {
      ...
      Logger.getLogger(jMetalExperimentTSP.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public static void main(String[] args) throws JMException, IOException {
    jMetalExperimentTSP exp = new jMetalExperimentTSP();

    exp.experimentName_ = "leaders_experiments";
    
    exp.algorithmNameList_ = new String[]{"NSGA-II","SPEA2"};
