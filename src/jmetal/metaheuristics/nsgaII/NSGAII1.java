...
public class NSGAII1 {
  ...
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
    ...
    fileHandler_ = new FileHandler("NSGAII1_ProblemTSP_main.log"); 
    logger_.addHandler(fileHandler_) ;
    
    String ruta_distancias = "distancias.txt";
    problem = new ProblemTSP("TSPPermutation", ruta_distancias);
    
    indicators = new QualityIndicator(problem, "FUN_NSGAII1"); //indicators = null ;
    ...
    population.printVariablesToFile("VAR_NSGAII1");
    logger_.info("Variables values have been writen to file VAR_NSGAII1");
    population.printObjectivesToFile("FUN_NSGAII1");
    logger_.info("Objectives values have been writen to file FUN_NSGAII1");
