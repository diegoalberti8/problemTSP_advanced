...
public class NSGAII4 {
  ...
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
    ...
    fileHandler_ = new FileHandler("NSGAII4_ProblemTSP_main.log"); 
    logger_.addHandler(fileHandler_) ;
    
    String ruta_distancias = "distancias.txt";
    problem = new ProblemTSP("TSPPermutation", ruta_distancias);
    
    indicators = new QualityIndicator(problem, "FUN_NSGAII4"); //indicators = null ;
    ...
    population.printVariablesToFile("VAR_NSGAII4");
    logger_.info("Variables values have been writen to file VAR_NSGAII4");
    population.printObjectivesToFile("FUN_NSGAII4");
    logger_.info("Objectives values have been writen to file FUN_NSGAII4");
