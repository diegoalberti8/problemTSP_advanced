...
public class SPEA21 {
  ...
  public static void main(String [] args) throws JMException, IOException, ClassNotFoundException {
    ...
    fileHandler_ = new FileHandler("SPEA21_ProblemTSP_main.log"); 
    logger_.addHandler(fileHandler_) ;
    
    String ruta_distancias = "distancias.txt";
    problem = new ProblemTSP("TSPPermutation", ruta_distancias);
    
    indicators = new QualityIndicator(problem, "FUN_SPEA21");  //indicators = null ; 
    ...
    population.printObjectivesToFile("FUN_SPEA21");
    logger_.info("Objectives values have been writen to file FUN_SPEA21");
    population.printVariablesToFile("VAR_SPEA21");
    logger_.info("Variables values have been writen to file VAR_SPEA21");
