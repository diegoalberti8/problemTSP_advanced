...
public class SPEA22 {
  ...
  public static void main(String [] args) throws JMException, IOException, ClassNotFoundException {
    ...
    fileHandler_ = new FileHandler("SPEA22_ProblemTSP_main.log"); 
    logger_.addHandler(fileHandler_) ;
    
    String ruta_distancias = "distancias.txt";
    problem = new ProblemTSP("TSPPermutation", ruta_distancias);
    
    indicators = new QualityIndicator(problem, "FUN_SPEA22");  //indicators = null ;
    ...
    population.printObjectivesToFile("FUN_SPEA22");
    logger_.info("Objectives values have been writen to file FUN_SPEA22");
    population.printVariablesToFile("VAR_SPEA22");
    logger_.info("Variables values have been writen to file VAR_SPEA22");
