...
public class SPEA24 {
  ...
  public static void main(String [] args) throws JMException, IOException, ClassNotFoundException {
    ...
    fileHandler_ = new FileHandler("SPEA24_ProblemTSP_main.log"); 
    logger_.addHandler(fileHandler_) ;
    
    String ruta_distancias = "distancias.txt";
    problem = new ProblemTSP("TSPPermutation", ruta_distancias);
    
    indicators = new QualityIndicator(problem, "FUN_SPEA24");  //indicators = null ;
    ...
    population.printObjectivesToFile("FUN_SPEA24");
    logger_.info("Objectives values have been writen to file FUN_SPEA24");
    population.printVariablesToFile("VAR_SPEA24");
    logger_.info("Variables values have been writen to file VAR_SPEA24");
